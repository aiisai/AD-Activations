# test Sigmoids with hyper-parameter set2
import torch
...
def train(epoch, optimizer, network, last_loss):
    ...
    inputs1 = inputs1.reshape([30, 100, 1])
    inputs2 = inputs2.reshape([30, 100, 1])
...
def main(argv):
    ...
    output_file = "experiments/HyperPara2/" + type + "_L" + str(n_layers) + "_Batch100_IXavier_B0_Epoch300-.csv"
